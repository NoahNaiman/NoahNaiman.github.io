$(document).ready(function(){
	...
	var terminalTimestamp = 'Last login: ' + days[dayName-1] + ' ' + months[month] +  ' ' + day + ' ' + time + ' on ttys000';
		...
		$('.type-it').typeIt({
			...
			callback: function(){
			    setTimeout(function(){
			    	$('body').append('<div id="jumbotron"><section id="big-name"><h1>Noah Naiman</h1><h2>COMING SOON: GO TO <a><href="https://github.com/NoahNaiman"<a>></h2><br><br><br><br><br><br><br><h3>Hit Enter</h3></section></div>');
